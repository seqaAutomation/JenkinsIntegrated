...
public class Base extends HelperFunctions {
  ...
  public void startTest(final ITestContext testContext) {
	  ...
	  String reportFolder = "CWB_1904_"+productName+"_"+LocalDateTime.now().format(DateTimeFormatter.ofPattern("ddMMMYY_HHmmss"));
	...
	if(sendEmail.toLowerCase().equalsIgnoreCase("yes"))
	{
		String emailId = fileUtility.getDataFromConfig("EmailId");
	              if(reportPath.size()>0){
	                  ...
	                  email.setSubject("SEQA Gmail Automation Test Result"); // Set the email's subject field </li>
